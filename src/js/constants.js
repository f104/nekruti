...
export const FORM_INPUT_BUTTON_PASSWORD_CLASS = 'js-input__button-password'
...
export const DATA_APP_MESSAGE = 'data-app-message'
...
// sliders
export const SWIPER_BTN_PREV_CLASS = 'swiper-button-prev'
export const SWIPER_BTN_NEXT_CLASS = 'swiper-button-next'
export const SWIPER_BTN_DISABLED_CLASS = 'swiper-button-disabled'
export const SWIPER_PAGINATION_CLASS = 'swiper-pagination'
export const SWIPER_HIDE_IN_TRANSITION_CLASS = 'swiper-hide-on-transition'
export const SWIPER_FRACTION_LANG_RU = 'из'
